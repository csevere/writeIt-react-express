...
//need promise in postgres to make sure you get data from database
// bluebird is a promise library 
var Promise = require('bluebird');
//converting prostgress into a bluebird promise
...
//     var synopsisDataQuery = `SELECT * FROM synopsis WHERE username= '${username}' AND book = '${book}';`;
//     connection.query(synopsisDataQuery, (error, response)=>{
//         if(error){
//             throw error;
//         }else{
//             console.log(response);
//             res.json({
//                 synopsisData: response[0]
//             })
//         }
//
//     })
